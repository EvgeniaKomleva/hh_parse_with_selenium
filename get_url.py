...
#url = "https://hh.ru/search/resume?area="+area+"&clusters=true&exp_company_size=any&exp_industry=any&exp_period=all_time&logic=normal&no_magic=False&order_by=relevance&pos=full_text%2Cworkplace_position&text="+search_text+"&specialization="+specialization+"&search_period="+search_period+"&items_on_page=20"
url = "'https://hh.ru/resumes/analitik?search_period=30'"
#print(url)